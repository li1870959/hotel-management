<template>
  <div id="checkinAdd">
    <el-dialog :title="title" :visible.sync="visible" width="800px" :lock-scroll="false" :show-close="false" :close-on-click-modal="false">
      <el-form ref="checkinForm" :model="checkinForm" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="10">
            <el-form-item label="房号:" prop="roomId">
              <el-select v-model="checkinForm.roomId" placeholder="请选择房号" clearable>
