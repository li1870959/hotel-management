  ...
  <div id="updatePwd" style="background: transparent;border:1px solid gainsboro">
    <el-form :model="searchForm" :rules="rules" label-width="80px">
      <el-form-item label="原密码">
        <el-input v-model="searchForm.oldPassword" placeholder="请输入6位原密码">
        </el-input>
      </el-form-item>
      <el-form-item label="新密码">
        <el-input v-model="searchForm.newPassword" placeholder="新密码长度必须在6-16之间，且必须包含数字和字母" show-password>
        </el-input>
      </el-form-item>
      <el-form-item>
        <el-button style="width:100%;padding:11px;" type="primary" @click="updatePwd(searchForm)">修 改 密 码</el-button>
      </el-form-item>
    </el-form>
    <el-row>
...
#updatePwd {
    ...
    padding-right: 30px;
    width: 500px;
    background-color: rgba(49, 143, 254, 0.4);
    border-radius: 10px;
